...
abstract class Services{
  ...
  static Future<List<Riwayat>?> getListRiwayat() async {
    try {
      Response response = await Dio().post('https://demo-service.kemenkeu.go.id/perpustakaan/Sirkulasi/GetAll?PageSize=10&Page=1',
