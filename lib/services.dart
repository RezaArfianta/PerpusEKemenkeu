...
abstract class Services {
  ...
  static Future<RiwayatResponse?> getListHistory(int page) async {
    try {
      Response response = await Dio().post('https://demo-service.kemenkeu.go.id/perpustakaan/Sirkulasi/GetAll?PageSize=10&Page=$page',
  ...
  static getListRiwayat(int page) {}
